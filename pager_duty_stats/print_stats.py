...
if __name__ == "__main__":
	...
	parser.add_argument('--end-date', default=str(datetime.now().date()), help='Date to collect alerts until')
	...
	parser.add_argument('--grouping-window', default='week', type=GroupingWindow, choices=list(GroupingWindow))

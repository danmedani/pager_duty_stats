...
def parse_args() -> Namespace:
	...
	parser.add_argument('--include-time-of-day-counts', action='store_true', default=False, help='Include breakdown of what time (work hours, off hours, sleep hours) errors are happening?')
